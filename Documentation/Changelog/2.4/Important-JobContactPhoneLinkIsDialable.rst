...
exactly as :php:`EXT:academic_persons` now does for the phone numbers of a
profile; the visible link text keeps the stored spelling.
...
:html:`href` attribute is. Nothing has to be configured or migrated. TYPO3 v12
and v13 behave alike here.
